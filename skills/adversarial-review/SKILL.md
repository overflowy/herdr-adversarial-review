...
- `ADVERSARIAL_REVIEW_CMD` — override the reviewer command (default
  `safecodex --disallowedTools Task,Agent,WebSearch,WebFetch --effort medium --disable-slash-commands`).
